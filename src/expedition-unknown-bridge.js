(function (root, factory) {
  ...
  const api = {
    ...
    loadForcedMarch, loadFieldCamp, loadCampSupplyRelief, loadPlayerCache, loadNightWatch, loadVillageBell, loadLostLootRecovery, loadLootAppraisal, loadBanditCaptive,

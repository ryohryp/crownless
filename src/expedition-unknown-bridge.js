(function (root, factory) {
  ...
  const api = {
    ...
    loadForcedMarch, loadFieldCamp, loadCampSupplyRelief, loadPlayerCache, loadNightWatch, loadVillageBell, loadMineApproach, loadLostLootRecovery, loadLootAppraisal, loadBanditCaptive,

...
(() => {
  ...
  const riskSummary = x => `鉄片 ${x.scrap}${x.gear.length ? `・${x.gear.map(g => E.GEAR[g].name).join('・')}` : ''}`;
  function onboard() {

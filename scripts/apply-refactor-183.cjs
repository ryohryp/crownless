...
requireCondition(
  integratedApp.includes('CombatActionProfiles.techniqueProfile(weapon, counter)') &&
    ...
    integratedApp.includes('CombatActionProfiles.battlefieldWeaponSpec(enemy.kind)') &&
